...
namespace ComputorV2
{
    public class Expression
    {
        ...
        public BigNumber EvaluateFunctionWithTokens(ExpressionProcessor ep, List<RPNToken> parameterTokens, out string evaluatedExpression)
        {
            if (!IsFunction)
            ...
            evaluatedExpression = string.Join("", resultTokens.Select(t=>t.str));
