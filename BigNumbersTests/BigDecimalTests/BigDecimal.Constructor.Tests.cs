...
namespace BigNumbersTests.BigDecimalTests
{
    ...
    public class BigDecimalConstructorTests
    {
        ...
        {
            var actual = new BigDecimal("-0000");
        ...
        {
            var actual = new BigDecimal("0000.000");
        ...
        {
            var actual = new BigDecimal("-000.5000");
        ...
        {
            var actual = new BigDecimal("-00001234.0024823000");
        ...
        {
            var actual = new BigDecimal("-00001234");
        ...
        {
            var actual = new BigDecimal("12.0");
        ...
        {
            var actual = new BigDecimal(" +12.3");
        ...
        {
            var actual = new BigDecimal("    -6473794237942.4723984729");
